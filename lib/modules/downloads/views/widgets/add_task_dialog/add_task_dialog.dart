...
class _AddTaskDialogState extends State<AddTaskDialog>
                  ...
                  trailing: Row(
                    ...
                    children: [
                      IconButton(
                        ...
                        onPressed: _selectedLinkIndex==0 ? null : () {
                          _pageController.jumpToPage(_selectedLinkIndex-1);
                        },
                      ),
                      IconButton(
                        icon: Icon(Icons.chevron_right_rounded),
                        onPressed: _selectedLinkIndex==_downloadTasks.length-1 ? null : () {
                          _pageController.jumpToPage(_selectedLinkIndex+1);
                        },
                      ),
                    ],
                    ...
                    child: Container(
                      ...
                      child: PageView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          if(task.status==null){
                            return Column(
                              children: List.generate(4, (index) => ListTileSkeleton()),
                            );
                          }
  ...
  bool get _isValidLinks => _errorTextLink == null && _linkTextController.text.trim().length>0;
